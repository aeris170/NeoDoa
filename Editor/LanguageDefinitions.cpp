...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::NeoDoaComponentDefinition() {
	static bool inited = false;
	static LanguageDefinition langDef;
	if (!inited) {
		static const char* const cppKeywords[] = {
			"bool", "char", "component", "const", "double", "false",
			"float", "int", "long", "nullptr", "short", "signed",
			"static", "true", "unsigned"
		};
