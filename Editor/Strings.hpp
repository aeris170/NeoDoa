...
namespace WindowStrings {
    inline constexpr const char SceneHierarchyWindowName[]             { "Scene Hierarchy"                };
    inline constexpr const char ObserverWindowName[]                   { "Observer"                       };
    inline constexpr const char CodeEditorWindowName[]                 { "Code Editor"                    };
    inline constexpr const char ConsoleWindowName[]                    { "Console"                        };
    inline constexpr const char AssetManagerWindowName[]               { "Asset Manager"                  };
    inline constexpr const char SceneViewportWindowName[]              { "Scene Viewport"                 };
    inline constexpr const char GameViewportWindowName[]               { "Game Viewport"                  };
    inline constexpr const char SceneSettingsWindowName[]              { "Scene Stats/Settings"           };
    inline constexpr const char UndoRedoHistoryWindowName[]            { "Undo/Redo History"              };
    inline constexpr const char SceneViewportCameraSettingsWindowName[]{ "Scene Viewport Camera Settings" };

    inline constexpr auto SceneHierarchyWindowTitle             { cat(WindowIcons::SCENE_HIERARCHY_WINDOW_ICON,                " ", SceneHierarchyWindowName)              };
    inline constexpr auto ObserverWindowTitle                   { cat(WindowIcons::OBSERVER_WINDOW_ICON,                       " ", ObserverWindowName)                    };
    inline constexpr auto CodeEditorWindowTitle                 { cat(WindowIcons::CODE_EDITOR_WINDOW_ICON,                    " ", CodeEditorWindowName)                  };
    inline constexpr auto ConsoleWindowTitle                    { cat(WindowIcons::CONSOLE_WINDOW_ICON,                        " ", ConsoleWindowName)                     };
    inline constexpr auto AssetManagerWindowTitle               { cat(WindowIcons::ASSET_MANAGER_WINDOW_ICON,                  " ", AssetManagerWindowName)                };
    inline constexpr auto SceneViewportWindowTitle              { cat(WindowIcons::SCENE_VIEWPORT_WINDOW_ICON,                 " ", SceneViewportWindowName)               };
    inline constexpr auto GameViewportWindowTitle               { cat(WindowIcons::GAME_VIEWPORT_WINDOW_ICON,                  " ", GameViewportWindowName)                };
    inline constexpr auto SceneSettingsWindowTitle              { cat(WindowIcons::SCENE_SETTINGS_WINDOW_ICON,                 " ", SceneSettingsWindowName)               };
    inline constexpr auto UndoRedoHistoryWindowTitle            { cat(WindowIcons::UNDO_REDO_HISTORY_WINDOW_ICON,              " ", UndoRedoHistoryWindowName)             };
    inline constexpr auto SceneViewportCameraSettingsWindowTitle{ cat(WindowIcons::SCENE_VIEWPORT_CAMERA_SETTINGS_WINDOW_ICON, " ", SceneViewportCameraSettingsWindowName) };

    inline constexpr const char ImGuiIDDesignator[]               { "###" };
    inline constexpr auto SceneHierarchyWindowTitleID             { cat(SceneHierarchyWindowTitle.c,  ImGuiIDDesignator, SceneHierarchyWindowName)                          };
    inline constexpr auto ObserverWindowTitleID                   { cat(ObserverWindowTitle.c,        ImGuiIDDesignator, ObserverWindowName)                                };
    inline constexpr auto CodeEditorWindowTitleID                 { cat(CodeEditorWindowTitle.c,      ImGuiIDDesignator, CodeEditorWindowName)                              };
    inline constexpr auto ConsoleWindowTitleID                    { cat(ConsoleWindowTitle.c,         ImGuiIDDesignator, ConsoleWindowName)                                 };
    inline constexpr auto AssetManagerWindowTitleID               { cat(AssetManagerWindowTitle.c,    ImGuiIDDesignator, AssetManagerWindowName)                            };
    inline constexpr auto SceneViewportWindowTitleID              { cat(SceneViewportWindowTitle.c,   ImGuiIDDesignator, SceneViewportWindowName)                           };
    inline constexpr auto GameViewportWindowTitleID               { cat(GameViewportWindowTitle.c,    ImGuiIDDesignator, GameViewportWindowName)                            };
    inline constexpr auto SceneSettingsWindowTitleID              { cat(SceneSettingsWindowTitle.c,   ImGuiIDDesignator, SceneSettingsWindowName)                           };
    inline constexpr auto UndoRedoHistoryWindowTitleID            { cat(UndoRedoHistoryWindowTitle.c, ImGuiIDDesignator, UndoRedoHistoryWindowName)                         };
...
namespace SceneViewportStrings {
    namespace Gizmos {
...
namespace ComponentDefinitionViewStrings {
